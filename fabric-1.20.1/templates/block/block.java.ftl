	...
	</#if>
{
	...
	public ${name}Block() {
		...
		<#if (data.rotationMode != 0 || data.isWaterloggable)>
			<#assign isVanillaBase = data.blockBase?has_content && (data.blockBase == "Fence" || data.blockBase == "Wall" || data.blockBase == "Stairs" || data.blockBase == "Slab" || data.blockBase == "Pane" || data.blockBase == "TrapDoor" || data.blockBase == "Leaves" || data.blockBase == "Door" || data.blockBase == "FenceGate" || data.blockBase == "Button" || data.blockBase == "PressurePlate")>
			<#if !isVanillaBase>
			...
			<#else>
				<#assign nativeWaterlogged = data.blockBase?has_content && (data.blockBase == "Fence" || data.blockBase == "Wall" || data.blockBase == "Stairs" || data.blockBase == "Slab" || data.blockBase == "Pane" || data.blockBase == "TrapDoor" || data.blockBase == "Leaves")>
				<#if data.isWaterloggable && !nativeWaterlogged>
